...
namespace backend.Managers.ActionResult.Responses
{
    ...
    {
        public static Response IsLockedOut() => new Response() { Code = nameof(IsLockedOut), StatusCode = 423, Description = "The user is locked out" };
        public static Response IsNotAllowed() => new Response() { Code = nameof(IsNotAllowed), StatusCode = 405, Description = "The user is not allowed" };
        public static Response RequiresTwoFactor() => new Response() { Code = nameof(RequiresTwoFactor), StatusCode = 400, Description = "The user requires two factor authentication" };
        public static Response FailUserCredentials() => new Response() { Code = nameof(FailUserCredentials), StatusCode = 401, Description = "Incorrect username or password" };
    }
}
