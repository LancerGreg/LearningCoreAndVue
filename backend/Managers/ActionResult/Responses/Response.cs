...
namespace backend.Managers.ActionResult.Responses
{
    ...
    public class BaseResponse
    {
        ...
        public static Response InternalError() => new Response() { Code = "InternalError", StatusCode = 500, Description = "An error occurred on the server. Please try again later or contact your administrator" };
        public static Response PageNotFound() => new Response() { Code = "PageNotFound", StatusCode = 404, Description = "Page not found" };
